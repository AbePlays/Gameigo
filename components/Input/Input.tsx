import { forwardRef, useColorMode, Input as ChakraInput, InputProps } from '@chakra-ui/react';
...
const Input = forwardRef<InputProps & Props, 'input'>(({ placeholder, ...props }, ref) => {
